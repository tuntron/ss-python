...
pre_install(){
    ...
    read -p "(Default password: cc112233):" shadowsockspwd
    [ -z "${shadowsockspwd}" ] && shadowsockspwd="cc112233"
    echo
    echo "---------------------------"
...
install(){
    ...
    if [ -f /usr/bin/ssserver ] || [ -f /usr/local/bin/ssserver ]; then
        ...
        echo
        echo -e "[${red}Error${plain}] Shadowsocks install failed! please visit shadowsocks and contact."
        install_cleanup
        exit 1
    fi
